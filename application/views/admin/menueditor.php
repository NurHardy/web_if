...
<div id='menuEditorWorkspace'>
	<div style='width: 300px; float: left;'>
		<select size="15" style='width: 300px' id='listMenu' style='padding: 10px;' onchange='updateControlButtons();' ondblclick='editMenuItem()'>
			
		</select>
		<div id='menuControl'>
			<button onclick='editMenuItem();' id='btnEdit'>Edit Item</button><br>
			<button onclick='moveItemUp();' id='btnMoveUp'>Move Up</button>
			<button onclick='moveItemLeft();' id='btnMoveLeft'>&lt;</button><button onclick='moveItemRight();' id='btnMoveRight'>&gt;</button>
