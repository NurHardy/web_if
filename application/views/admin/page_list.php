...
<h3>Website Pages:</h3>
<a href='<?php echo base_url('/admin/pages/newpage'); ?>' class='button_admin btn_add'>Buat baru &raquo;</a>
<hr>
...
<?php
 ...
 foreach($_pages as $_page) {
	...
	echo "<td>$_ctr</td><td><a href='".base_url("/admin/pages/editpage/{$_page->f_id}/")."'>{$_page->f_title}</a></td>";
	echo "<td><a href='#'><img src='".base_url('/assets/images/admin/admin_unpub.png')."' alt='Unpublish -' class='img_icon' title='Unpublish'/></a>";
	echo "<a href='#'><img src='".base_url('/assets/images/admin/admin_del.png')."' alt='Hapus' class='img_icon' title='Hapus'/></a></td>";
	echo "</tr>\n";
 }
?>
</table>
